...
class weatherPage extends StatefulWidget {
  ...
  weatherPage({required this.isDarkMode, required this.toggleDarkMode});

  _wetharPageState createState() => _wetharPageState();
}

class _wetharPageState extends State<weatherPage> {
  final _weatherService = WeatherService('2eb55fb84272d17910c7f80f1beacd97');
  weather? _weather;
